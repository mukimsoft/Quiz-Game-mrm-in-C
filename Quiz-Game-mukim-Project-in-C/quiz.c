//c project on quiz game by Mukim
#include<stdio.h>
#include<conio.h>
#include<ctype.h>
#include<stdlib.h>
...
void help()
{
    ...
    printf("\n    total 10 questions each right answer will be awarded TK 2000.");
    printf("\n    By this way you can win upto ONE MILLION cash prize in BDT TK...............");
    printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option");
